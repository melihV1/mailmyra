...
const tr: Mirror<typeof en> = {
  ...
  table: {
    ...
    filterAssignmentAria: 'Atamaya göre filtrele',
    allAssignments: 'Tüm atamalar',
    assigned: 'Atanmış',
    unassigned: 'Atanmamış',
    filterTemplateAria: 'Şablona göre filtrele',
    ...
    noMatchTitle: 'Bu filtrelere uyan imza yok',
    noMatchBody: 'Farklı bir arama dene ya da atama ve şablon filtrelerini genişlet.',
