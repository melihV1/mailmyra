  ...
  steps: {
    ...
    style: {
      ...
      template: {
        ...
        dividerColumnsName: 'Corporate divider',
        dividerColumnsBlurb: 'Logo left, a strong brand rule, contact on the right.',
        photoFirstName: 'Photo first',
        photoFirstBlurb: 'A big round portrait leads — built for personal brands.',
        ctaBannerName: 'CTA banner',
        ctaBannerBlurb: 'A full-width action bar closes the signature.',
      },
      colors: {
        groupTitle: 'Colors',
  ...
  steps: {
    ...
    style: {
      ...
      template: {
        ...
        dividerColumnsName: 'Kurumsal ayraçlı',
        dividerColumnsBlurb: 'Logo solda, güçlü marka çizgisi, iletişim sağda.',
        photoFirstName: 'Fotoğraf önde',
        photoFirstBlurb: 'Büyük portre önde — kişisel marka için.',
        ctaBannerName: 'CTA bantlı',
        ctaBannerBlurb: 'İmzayı tam genişlik eylem bandı kapatır.',
      },
      colors: {
        groupTitle: 'Renkler',
