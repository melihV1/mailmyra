...
export function GrowthPreviewPage({ crumb, title, support, render }: { crumb: string; title: string; support: string; render: (source: ProductAnalyticsSnapshot, now: number) => ReactNode }) {
