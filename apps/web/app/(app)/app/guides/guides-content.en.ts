/**
 * Kurulum rehberleri — İNGİLİZCE içerik. Bileşen sadece çizer; dil girişi
 * `guides.data.ts`teki `getGuides`/`getExportChain`.
 *
 ...
 *
 * Çeviri eşi: `guides-content.tr.ts` — iskelet (slug/icon/fidelity, grup ve
 * adım sayıları) `test/guides-parity.test.ts` ile kilitli.
 */
 ...
 */
export const EXPORT_CHAIN_EN: readonly GuideStep[] = [
  {
