...
async function main() {
  ...
  console.log(
    [
      ...
      '     sunucudaki Prisma istemcisi npm install sırasında üretiliyor;',
      '     install koşmayan deploy\'da istemci yeni kolonları TANIMAZ.',
      '     Tablolar migrate ile gelir ama istemcinin sözlüğü eski kalır.',
      '  3) Plesk > Node.js > Uygulamayı yeniden başlat',
      '  4) Siteyi aç ve kontrol et',
      '',
